        ...
        return (
          <div className="post-container">
            ...
            <p className="postContent">
              ...
              response to an achievement or special occasion. The free space is
              calculated after any non-flexible items. In this example the total
              amount of free space available to the fr units doesn’t include the
              50px
            </p>
